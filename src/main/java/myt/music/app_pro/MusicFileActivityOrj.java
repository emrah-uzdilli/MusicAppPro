...
public class MusicFileActivityOrj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mydialog = new ProgressDialog(MusicFileActivityOrj.this);
       ...
       // Collections.reverse(listMusicTime);
        ...
        FacebookAds.facebookInterstitialAd(MusicFileActivityOrj.this);
        ...
        public View getView(final int position, final View convertView, ViewGroup parent) {
            ...
            holder.btn_delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(MusicFileActivityOrj.this);
    ...
    public void play_media(final String audioFile){
        ...
        try {
            ...
            final ProgressDialog dialog = new ProgressDialog(MusicFileActivityOrj.this);
